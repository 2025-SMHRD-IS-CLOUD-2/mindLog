...
| 이름     | 역할             | 담당 업무 |
|----------|------------------|------------|
| 전대원   | Backend 개발     | 회원가입, 일정관리, 예약, 반응형 페이지 구현 및 기능 구현, 제안서 작성 및 수정 |
| 장영민   | AI/모델링        | 로그인, 회원정보 수정, 자가진단, 상담예약 성공 페이지 구현, 개발환경 구축, 시스템 아키텍처 설계, 상담예약 기능 구현 |
| 주현빈   | Frontend 개발    | 챗봇, 메인페이지 구현, 로그인/회원가입, 자가진단 문진표, 챗봇 기능 구현, DB 설계 및 구축, 데이터 수집 및 전처리, koBERT 모델 학습 및 구현, GPT 챗봇 서비스 연결 및 프롬프팅, 테이블명세서, 요구사항 정의서, DB요구사항분석서 작성, PPT 제작 |
| 황상제   | Backend 개발     | 상담센터 안내, 자가진단 페이지 구현, 상담센터 안내, 자가진단 페이지 기능구현, 지도 API 연결, 제안서 작성 |
